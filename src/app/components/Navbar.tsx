...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex justify-between items-center relative">
        <div 
          className="flex flex-col items-center justify-center w-[40px] h-[40px] gap-y-[5px] bg-orange-300 p-2 rounded-full cursor-pointer hover:contrast-75 smooth-animation"
          onClick={() => setTogglaNavbar(!toggleNavbar)}>
          <span className="border-t-2 border-orange-700 rounded-full w-full"></span>
          <span className="border-t-2 border-orange-700 rounded-full w-full"></span>
          <span className="border-t-2 border-orange-700 rounded-full w-full"></span>
        </div>
        <div className="bg-orange-300 rounded-md px-3 py-[3px] border-2 border-orange-700 text-orange-700 cursor-pointer hover:contrast-75 smooth-animation">Buat Cerpen</div>
